## Taken from https://github.com/cabol/shards

REBAR = $(shell which rebar3)

EPMD_PROC_NUM = $(shell ps -ef | grep epmd | grep -v "grep")

LOCAL_SUITES = "test/gen_buffer_SUITE,test/gen_buffer_partitioned_SUITE"
